...
calcul_frequence_mot = function(mon_texte){
  corpus_fichiers_ve1 = unlist(mon_texte)
  corpus_fichiers_liste = strsplit(corpus_fichiers_ve1," ")
  ...
  return(corpus_fichiers_freq[20:60])
...
matrice_freq_test = matrix(1, nrow = 1, ncol = 1, byrow = TRUE)
matrice_freq_test[1,1] = (calcul_frequence_mot(corpus_fichiers[1]))[1]
matrice_freq_test
#analyse de la fréquence de 40 mots parmi les 200 mots les plus fréquents de chaque pièce 
